...
""")
  ...
  def testAssignToPortalTypeClass(self):
    ...
    ## resets do not have any side-effect on Interfaces
    from zope.interface import Interface
    class ITestPortalType(Interface):
      """Anything"""
      def foo():
        """Anything"""
    # Create a module to hold the Interface class (will be imported in the
    # test ZODB Component)
...
""")
    ...
    self.assertTrue(ITestPortalType.implementedBy(
      self._module.TestPortalType.TestPortalType))
